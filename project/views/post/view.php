...
<div id="wrapper">
    ...
    <div id="page">
        <div id="content">
            <div class="post">
                <h2 class="title"><?= $model->getAttribute('name') ?></h2>

                <p class="date"><?=
                    date('d.m.Y', $model->getAttribute('adate'))
                    ?></p>
                ...
                <?php foreach ($comments as $comment): ?>
                    <div class="comment">
                        <div class="adate"><?= date('d.m.Y', $comment->getAttribute('adate')) ?></div>
                        <div class="username"><?= $comment->getAttribute('username') ?></div>
                        <div class="body"><?= $comment->getAttribute('body') ?></div>
                    </div>
                    <br><br><br>
                <?php endforeach; ?>

                <form action="/comment/create" method="post">
                    <input type="hidden" name="id_post" value="<?= $model->getAttribute('id') ?>"/>
                    ...
                    <div>
                        ...
                        <input name="body" value="" type="text" id="body"/>
                    </div>
                    <br>
                    <div>
